...
declare option exist:serialize "method=text media-type=text/plain omit-xml-declaration=yes";
 ...
 let $doc := doc($freidi-tmv:referenceSource-root||'/FreiDi_TopicMap_2.xml')(:$config:app-root||'/topicMaps/FreiDi_TopicMap_2.xml:)
 let $xslt := doc($config:app-root||'/data/xslt/tmxsl/xtm2tojtm1.xsl')
